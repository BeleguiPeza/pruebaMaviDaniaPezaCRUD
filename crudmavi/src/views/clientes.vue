<template>
  <div class="formClietes">
    <form @submit.prevent="postCliente">
      ...
      <input type="text" class="form-control" v-model="apellidoPaterno" /><br />
      <label class="form-label">Apellido Materno:</label><br />
      <input type="text" class="form-control" v-model="apellidoMaterno" /><br />
...
export default {
  ...
  methods: {
    ...
    deleteCliente(id) {
      this.axios.get(`/client/${id}`).then((response) => {
        this.getClientes();
      });
    },
    clearClientData() {
